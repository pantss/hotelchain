...
public class ReservationManagerTextInterface extends GuestRegistrationTextInterface
{
	...
	private void showReservationManager()
	{
		...
		String[] options = {"General information about reservations.",
											"Reserve a Room",
											"Find a Reservation",											
	...
	{
		chain.getReservationManager().printAllReservations();
	}
	...
	{
		if(hotel.isBridalSuiteAvailable(startDate, endDate))
		{
	...
	private void printReservation(Reservation res)
	{
		...
		System.out.println("From: " + chain.getReservationManager().calendarToString(res.getStartDate())
										+ "\nUntil:  " + chain.getReservationManager().calendarToString(res.getEndDate()));
		System.out.println("**********************");
	}
	...
	private void showFindReservation()
	{
		...
		if(!cancel)
		{
			Reservation reservation = chain.getReservationManager().findReservation(reservationID);
